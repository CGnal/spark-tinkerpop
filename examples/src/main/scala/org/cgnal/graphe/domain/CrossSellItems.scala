...
case class CrossSellItems(productId: Int, crossSellProductId: Int)

object CrossSellItems {

  def apply(productId: String, crossSellProductId: String): CrossSellItems = apply(productId.toInt, crossSellProductId.toInt)
